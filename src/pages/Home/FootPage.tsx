  ...
  return (
    <footer className={style.back}>
      <section className={style.sidebar}>
            ...
            <svg style={{margin:"0.04em"}} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" width="1.82em" height="1.82em" fill='white' onClick={() => {window.open('https://www.tiktok.com/@un_nutriscan')}}>
