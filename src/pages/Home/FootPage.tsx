  ...
  return (
    <footer className={style.back}>
      <section className={style.sidebar}>
        <a href='https://twitter.com/UN_ScanNutri'>
        ...
        <a href='https://www.instagram.com/un_nutriscan/'>
        ...
        <a href='https://www.facebook.com/profile.php?id=61556562670860'>
        ...
        <a href='https://www.tiktok.com/@un_nutriscan'>
